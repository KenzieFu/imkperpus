...
// http://localhost:8080/admin-perpustakaan-crown/buku-tahun-ajaran-baru
router.get("/buku-tahun-ajaran-baru", bukuController.getTahunAjaranBaruBooks);

// route untuk search buku
// http://localhost:8080/admin-perpustakaan-crown/search?keyword=fisika
router.get("/search", bukuController.searchBook);

// route untuk mengambil daftar buku per kategori
// http://localhost:8080/admin-perpustakaan-crown/buku/kategori/1
...
// http://localhost:8080/admin-perpustakaan-crown/buku-perpus/1
...
// http://localhost:8080/admin-perpustakaan-crown/buku-tahun-ajaran-baru/1
...
// http://localhost:8080/admin-perpustakaan-crown/kategori/1
router.get("/kategori/:kategoriId", kategoriController.getKategoriById);

// route untuk mengambil daftar kategori
// http://localhost:8080/admin-perpustakaan-crown/kategori
...
// http://localhost:8080/admin-perpustakaan-crown/guru
router.post("/guru", guruController.createGuru);

// route untuk mengupdate guru
// http://localhost:8080/admin-perpustakaan-crown/guru/1
...
// http://localhost:8080/admin-perpustakaan-crown/akun
router.delete("/akun", akunController.deleteAkunMultiple);


// route untuk aktivasi akun secara multiple
// http://localhost:8080/admin-perpustakaan-crown/akun-aktivasi
...
// http://localhost:8080/admin-perpustakaan-crown/akun/1
...
// http://localhost:8080/admin-perpustakaan-crown/peminjaman
router.post("/peminjaman", peminjamanController.createPeminjaman);

// route untuk mengupdate peminjaman
// http://localhost:8080/admin-perpustakaan-crown/peminjaman/1
...
// http://localhost:8080/admin-perpustakaan-crown/pengembalian/1
...
// http://localhost:8080/admin-perpustakaan-crown/pengembalian
router.get("/pengembalian", pengembalianController.getAllPengembalianAdmin);

// ROUTES FOR EVENTS

// route untuk menambahkan event
// http://localhost:8080/admin-perpustakaan-crown/event
router.post("/event", eventController.createEvent);

// route untuk mengupdate event
// http://localhost:8080/admin-perpustakaan-crown/event/1
...
// http://localhost:8080/admin-perpustakaan-crown/pesan-masuk
router.post("/pesan-masuk", pesanMasukController.createPesanMasuk);

// route untuk mengupdate pesan masuk
// http://localhost:8080/admin-perpustakaan-crown/pesan-masuk/1
...
// http://localhost:8080/admin-perpustakaan-crown/absensi
router.post("/absensi", absensiController.createAbsensi);

// route untuk mengupdate absensi
// http://localhost:8080/admin-perpustakaan-crown/absensi/1
...
// http://localhost:8080/admin-perpustakaan-crown/absensi-today
...
// http://localhost:8080/admin-perpustakaan-crown/pengunjung-harian
...
// http://localhost:8080/admin-perpustakaan-crown/absensi-keluar/1
...
// http://localhost:8080/admin-perpustakaan-crown/absensi-keluar-manual/1
