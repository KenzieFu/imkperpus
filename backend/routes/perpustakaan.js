...
// http://localhost:8080/perpustakaan-crown/jumlah-dipinjam/1
...
// // http://localhost:8080/perpustakaan-crown/siswa/buku/histori-peminjaman/1
...
// http://localhost:8080/admin-perpustakaan-crown/peminjamanBarcode
...
// http://localhost:8080/perpustakaan-crown/peminjaman-siswa
...
// http://localhost:8080/perpustakaan-crown/histori-peminjaman-siswa
...
// http://localhost:8080/perpustakaan-crown/pengembalian
router.get("/pengembalian", isAuth, pengembalianController.getPengembalian);

// ROUTES FOR EVENTS

// route untuk menambahkan event
// http://localhost:8080/perpustakaan-crown/event
router.post("/event", eventController.createEvent);

// route untuk mengupdate event
// http://localhost:8080/perpustakaan-crown/event/1
...
// http://localhost:8080/perpustakaan-crown/pemesanan-buku
router.post("/pemesanan-buku", pemesananarController.createPemesananBuku);

// route untuk menambahkan pemesanan buku multiple
// http://localhost:8080/perpustakaan-crown/pemesanan-buku-multiple
...
// http://localhost:8080/perpustakaan-crown/pemesanan-batal/1
...
// http://localhost:8080/perpustakaan-crown/pemesanan-buku-siswa
