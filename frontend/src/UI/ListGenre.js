...
export const ListGenre = ({genres,setGenre,current}) => {
    ...
    <li style={{ background:current===genre.id_kategori?"#fedaa7":"none",color:current===genre.id_kategori?"black":"white" }} id={genre.id_kategori}>
  ...
  <ul>
    ...
    <li style={{ background:current===0?"#fedaa7":"none",color:current==0?"black":"white" }}>
